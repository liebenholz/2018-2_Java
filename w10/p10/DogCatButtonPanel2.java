...
public class DogCatButtonPanel2 extends JPanel {

	
	public DogCatButtonPanel2() { // 구성자
		...
		animal.add(dog_button);
		animal.add(cat_button);
		
		add(label, BorderLayout.CENTER);
		add(animal, BorderLayout.SOUTH);
	}
	...
	protected static ImageIcon createImageIcon(String path, String description) {
		java.net.URL imgURL = DogCatButtonPanel2.class.getResource(path);
		if (imgURL != null) {
	...
	public static void main(String[] args) {
		...
		frame.add(new DogCatButtonPanel2());
