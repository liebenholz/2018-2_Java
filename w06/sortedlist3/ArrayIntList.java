...
/**
 * 정수만을 저장할 수 있는 ArrayList, 세 번째 버전.
 * Version 3.
 * 두 번째 버전에서 아래 내용이 변경됨.
 * - DEFAULT_CAPACITY, size, element 필드가 protected로 선언됨.
 *   (서브클래스에서 이 필드에 접근할 수 있게 함.)
 */
...
public class ArrayIntList {
	...
	/**
	 * 주어진 용량의 빈 리스트를 구성한다.
	 * @param capacity 초기 용량. {@literal capacity >= 0}.
	 */
	 ...
	 * 만약 배열이 이미 꽉 찬 상태이면 배열의 크기를 늘인다.
	 * @param index 인덱스. {@literal 0 <= index <= size}
	 * @param value 삽입할 값.
	 */
