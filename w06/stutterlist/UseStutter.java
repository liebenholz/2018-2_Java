...
public class UseStutter {
	...
	public static void main(String[] args) {
		...
		// 원소를 add하면 그 원소가 세 개 add되는 StutterIntList를 구성한다.
		// 중복도가 3인 StutterIntList!
		...
		// 이 StutterIntList의 중복도 (stretch factor) --> 3
		System.out.println("Stretch factor = " + list.getStretch());   
		System.out.println();

		// 이 StutterIntList에 5가 몇 개나 들어 있나?
		System.out.println("5는 " + list.count(5) + "개 들어 있다.");   
		System.out.println();
		...
		list = new StutterIntList(0);	// 중복도가 0이므로 
